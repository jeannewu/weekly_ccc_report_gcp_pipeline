...
knit: (function(inputFile, encoding) {rmarkdown::render("Consolidated_Weekly_Report_4Pipeline_BQupdated_06082023.Rmd", output_file=paste("Connect_WeeklyOperationsMetrics_", Sys.Date()-1, ".pdf", sep=""))})
...
write.csv(base,paste(outputpath,"CCC_metrics_weekly_log_labels_updated_",currentDate,".csv",sep=""),na="",row.names=F)
