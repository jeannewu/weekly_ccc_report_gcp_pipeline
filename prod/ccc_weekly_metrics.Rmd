...
for(site in unique(data[which(data$d_827220437>0),]$site)){
  ...
  verinot_site <- rbind(verinot_site,tmp, fill=TRUE)
} 
...
for(site in unique(data[which(data$d_827220437>0),]$site)){
  ...
  campaign.site <- rbind(campaign.site,verified.tb, fill=TRUE)
  ...
  total.veri_pct <- pct_tb(data[which(data$d_512820379==486306141),]$active_camptype,     data[which(data$d_512820379==486306141),]$Rcrt_Verified_v1r0)
       ...
       campaign.combo <- rbind(campaign.site,act.veri.camp,fill=TRUE)
...
table10_Tm_recr_sign <- rbind(table10_Tm_recr_sign1,table10_Tm_recr_sign.total, fill=TRUE)
...
table11_Tm_signin_cst.act <- rbind(table11_Tm_signin_cst.act,table11_Tm_signin_cst[which(table11_Tm_signin_cst$recruitment_type=="Active"),c(2:10)], fill=TRUE)
