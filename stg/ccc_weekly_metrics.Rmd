...
for (i in (1:length(start)))  {
  ...
  tmp <- eval(parse(text=paste("bq_project_query(project, query=\"SELECT token,Connect_ID,", select,"FROM `nih-nci-dceg-connect-stg-5519.FlatConnect.participants_JP` Where d_512820379 != '180583933' \")",sep=" ")))
